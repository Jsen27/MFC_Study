...
int main()
{
    ...
    if (hModule != nullptr)
    {
        ...
        else
        {
            ...
            _tprintf(_T("Hello from %s!"), (LPCTSTR)str);
            getchar();*/
            ...
            //CString str3(str2); // CString객체를 생성자 인자로 전달한다.
            ...
            //_tprintf(_T("%d, %d\n"), pt1.x, pt1.y);
            //_tprintf(_T("%d, %d\n"), pt2.x, pt2.y);
            //pt1.Offset(40, 30); // x, y 좌표에 각각 40, 30 을 더한다.
            //pt2.Offset(20, 10); // x, y 좌표에 각각 20, 10 을 더한다.
            //_tprintf(_T("%d, %d\n"), pt1.x, pt1.y);
            //_tprintf(_T("%d, %d\n"), pt2.x, pt2.y);
            ...
            _tsetlocale(0, _T("")); // 유니코드 한국어 출력에 필요
